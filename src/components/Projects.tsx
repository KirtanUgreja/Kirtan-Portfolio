...
const projects = [
    {
        ...
        title: "SMS-GPT",
        description:
            "An offline LLM chat system that operates entirely over SMS — enabling AI-powered conversations on any device, anywhere, without internet. Built with Twilio, Python, and language model integration for seamless real-time responses.",
        tags: ["Python", "AI", "Twilio", "LLM", "SMS"],
        github: "https://github.com/KirtanUgreja/SMS-GPT.git",
        icon: "💬",
    },
    {
        number: "02",
        title: "n8n Workflows",
        description:
            "Enterprise-grade business automation workflows designed during my internship at Sentiimenta AI. Automated complex processes including lead management, client onboarding, and data pipeline orchestration for D2C brands.",
        tags: ["n8n", "Automation", "AI", "Workflows", "API"],
        github: "https://github.com/KirtanUgreja/n8n-workflows-k.git",
        icon: "⚡",
    },
    {
        number: "03",
        title: "CodeBlocking",
        description:
            "A container-based online code editor where users can write, compile, and run code directly in the browser — zero installation required. Uses Docker for secure sandbox execution with real-time output streaming.",
        tags: ["Docker", "React", "Node.js", "WebSocket", "Cloud"],
        github: "https://github.com/KirtanUgreja/codeblocking.git",
        icon: "🧱",
    },
];
